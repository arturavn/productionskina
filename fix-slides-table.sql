-- Script para corrigir a tabela slides
-- Este script dropa a tabela existente e recria com a estrutura correta

-- Dropar a tabela slides existente (se existir)
DROP TABLE IF EXISTS slides CASCADE;

-- Recriar a tabela slides com a estrutura correta
CREATE TABLE slides (
...
SELECT 'Tabela slides recriada com sucesso!' as resultado;